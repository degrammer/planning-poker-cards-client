...
let config = {
    ...
    cssDependencies: packageFile.cssVendors,
    cssVendorPath : 'vendors.css',
...
gulp.task('default', ['watch', 'webserver', 'vendor','css-vendor', 'index', 'routes', 'views', 'less-modules', 'js-singles', 'kepler', 'images', 'jasmine', 'spec']);
...
gulp.task('css-vendor', function() {
    ...
    return gulp.src(config.cssDependencies)
        .pipe(plumber({ errorHandler: notify.onError('<%= error.message %>') }))
        .pipe(concat(config.cssVendorPath))
